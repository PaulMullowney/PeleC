...
LAUNCHER="${LAUNCHER:-mpirun -np $RANKS --mca coll_ucc_enable 1 --mca coll_ucc_priority 100 --mca pml ucx --mca osc ucx}"
...
EXEC="${EXEC:-./}PeleC3d.gnu.TPROF.MPI.CUDA.ex.${MODEL}"
if [[ $MODEL == "drm19" ]]
then
